...
export default function GanttChart() {
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden text-sm font-satoshi mt-4">
      ...
      {/* Header: Weeks */}
      <div className="grid grid-cols-12 bg-[#F9F9F9] border-b border-gray-200 py-2 text-[var(--color-brand-navy)] font-bold text-center">
      ...
      <div className="divide-y divide-gray-100">
        {tasks.map((task) => (
          <div key={task.id} className="grid grid-cols-12 items-center hover:bg-gray-50 transition-colors">
            ...
            {/* Task Name & Phase */}
            <div className="col-span-4 px-6 py-2 flex flex-col justify-center">
