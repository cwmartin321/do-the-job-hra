...
export const slides: SlideData[] = [
  ...
  },
  {
    ...
    body: "The core objective of the engagement was global risk mitigation by eliminating the impact of ungoverned pay changes for the client.",
    layout: 'icon-grid',
    iconGridItems: [
      ...
      { icon: "Network", title: "Global Framework", text: "Established a consistent, repeatable global governance approach." }
    ]
  },
  {
    id: "slide-3-discovery",
    title: "Needs Assessment: ~~Discovery~~",
    body: "I led the initial discovery phase, focusing on the customer's historical comfort with pay equity analyses to define the project's success criteria.",
    layout: 'split',
    splitContent: { icon: "Search", sideText: "Discovery Phase & Requirements Gathering" },
    bulletPoints: [
      "We evaluated their past reliance on external consultants and lawyers.",
      "We defined project success by targeting optimized remediation budgets.",
  ...
  },
  {
    ...
    body: "Through partnership with the customer, we tuned the configuration of the solution to meet the unique, multi-national regulatory demands of the pharmaceutical industry.",
    layout: 'icon-grid',
    iconGridItems: [
      ...
      { icon: "BarChart3", title: "Statistical Rigor", text: "Demonstrated the statistical rigor of our industry leading methodologies." },
  ...
  },
  {
    ...
    body: "I proactively mitigated incomplete HRIS and payroll data risks to ensure we maintained momentum the 8-week timeline.",
    layout: 'process',
    processSteps: [
      { title: "Define Requirements", description: "Provided clear expectations for their minimum data requirements.", icon: "FileText" },
      { title: "Gap Analysis", description: "Dedicated specific weekly calls to data review and gap analysis.", icon: "Search" },
  ...
  },
  {
    ...
    body: "I successfully navigated timeline shifts caused by their evolving business priorities, such as M&A activity.",
    layout: 'split',
    splitContent: { icon: "Compass", sideText: "Navigating Organizational Shifts" },
    bulletPoints: [
      "We established a core working team to maintain the project's momentum.",
      "Foundational integration readiness requirements were locked in early.",
      "Clearly defined core roles to protect thetimeline against external delays.",
      "I aligned their shifting priorities with realistic milestone targets."
    ]
  },
  {
    id: "slide-9-training-methodology",
    title: "Training: ~~Methodology~~",
    body: "We scheduled and executed a robust, hands-on learning model designed to transition the client's team away from external consultants.",
    layout: 'icon-grid',
    iconGridItems: [
      { icon: "Database", title: "Live Data Validation", text: "Utilized the customer's live data to help them validate statistical models." },
      { icon: "LineChart", title: "Results Interpretation", text: "Taught their teams how to interpret the pay equity results and equity issue resolution." },
      { icon: "ShieldCheck", title: "Building Trust", text: "Built their trust in the platform's mathematical output through practical use cases of the software." },
  ...
  },
  {
    ...
    body: "Developed a scaled enablement strategy across multiple timezones through targeted resource deployment.",
    layout: 'stats',
    stats: [
      { value: "SMEs", label: "Trained internal subject matter experts to upskill their teams." },
      { value: "On-Demand", label: "Provided on-demand video content to support their specific customer journey." },
  ...
  },
  {
    ...
    pillars: [
      ...
      { title: "Global Training", description: "Deployed comprehensive training plans across the Americas, EMEA, and APAC regions.", icon: "Globe" },
  ...
  },
  {
    ...
    body: "The successful implementation immediately proved its ROI by enabling the customer to navigate complex structural changes efficiently.",
    layout: 'icon-grid',
    iconGridItems: [
